...
* No real file extraction occurs during updates.
* No hardware communication is performed.
* Timezone resolution depends on host OS availability.
* Designed to validate **architecture & behavior**, not deployment.

---

## 📜 License

This project follows the license defined in the repository root.

---

## 🙌 Purpose

This PoC demonstrates how a modern **.NET 8 Generic Host** can model:

* Embedded device orchestration
* Fault detection
